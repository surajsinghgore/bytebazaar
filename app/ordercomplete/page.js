    ...
    <div className={style.ordercomplete}>
      <div className={style.left}>
        ...
        <div className={style.details}>
          <li>
            <b>Name</b> <span>Jane smith</span>
          </li>
          <li>
            <b>Address</b>{" "}
            <span>456 Oak St #3b, sans francisco, CA 6475 United States</span>
          </li>
          <li>
            <b>Phone</b> <span>+91 7859875898</span>
          </li>
          <li>
            <b>Email</b> <span>jane.smith@email.com</span>
          </li>
        </div>
      </div>
      ...
      <div className={style.right}>
        ...
        <div className={style.items}>
          ...
          <div className={style.rs}>$50.0</div>
        </div>

        <div className={style.innerDetails}>
          <li>
            <span>Sub Total</span> <span>$100.90</span>
          </li>
          <li>
        ...
        <div className={style.total}>
          <li>
            <span>Order Total</span> <span>$107.00</span>
          </li>
        </div>
      </div>
    </div>
